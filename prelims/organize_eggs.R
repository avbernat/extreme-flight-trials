...
setwd("~/Desktop/git_repositories/extreme-flight-trials/prelims/data/")


masterpath = "~/Desktop/git_repositories/SBB-dispersal/avbernat_working_on/Dispersal/Summer_2021/windaq_processing/data/"
masterlist = read.csv(paste0(masterpath, "masterlist.csv"), header=TRUE, sep=",", quote="", stringsAsFactors=FALSE)
...
eggdata = read.csv("egg_tube_data3.csv", header=TRUE, sep=",", quote="", stringsAsFactors=FALSE)
eggdata$`dead?` = ""
head(eggdata)
